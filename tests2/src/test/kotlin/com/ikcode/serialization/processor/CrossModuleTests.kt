...
import com.ikcode.serialization.processor.examples.inheritance.ImplementationData3
import com.ikcode.serialization.processor.examples.inheritance.ImplementationData3_Packer
...
class CrossModuleTests {
    ...
    @Test
    fun crossModuleImplementationTests2() {
        val referencedData1 = ObjectSample(1)
        val referencedData2 = ObjectSample(2)
        val data = ImplementationData3(
            referencedData1, referencedData1, null, referencedData1,
            referencedData2, referencedData2, null, referencedData2
        ).apply {
            mutable1 = referencedData1
        ...
        val session = PackingSession()
        val pointer = ImplementationData3_Packer().pack(data, session) as ReferencePointer
        val packed = session.referencedData.first { it.pointer == pointer}.dataMap
