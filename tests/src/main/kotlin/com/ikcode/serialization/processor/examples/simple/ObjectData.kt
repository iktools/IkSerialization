...
class ObjectData(
    ...
    @SerializationData var mutable1 = ObjectSample()
    @SerializationData var nullableNull1: ObjectSample? = ObjectSample()
    @SerializationData var nullableValue1: ObjectSample? = ObjectSample()
